...
class NuwaSkill(BaseSkill):
    ...
    async def generate_response(self, persona_name: str, user_input: str, session_id: str) -> str:
        """生成基于特定思维模型的回复"""
        ...
        # 调用 LLM
        response = await self.llm.ainvoke(self.contexts[session_id])
...
"""
    ...
    def run(self, data: Any, context: Dict[str, Any] = None) -> Any:
        ...
        return asyncio.run(self.generate_response(persona, str(data), session_id))
