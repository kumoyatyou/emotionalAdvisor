...
- 🔒 **隐私至上 (Privacy First)**
  - 所有聊天记录、知识库索引以及生成的联系人档案均严格保存在本地 `user_profile/`、`data/raw/`、`db/`和`crushes/` 目录中。
...
> “我的名字是xxx，出生于xxxx年x月x日x时，帮我排一下八字。”
> “我今天约 Alice 出来合适吗？结合我们的八字命理分析一下今天的策略。”
...
> *P.S. 你可以自由地复制、修改和分发这些代码，甚至完全不需要在你的项目中保留我的署名。
> 毕竟，把“感情小胡沛杉的出生时间是22006年丑”的经历四处声张确实有些难为情。只要这个工具能帮你避开我曾踩过的坑，那就足够了。
> 祝你在爱里得偿所愿。*
